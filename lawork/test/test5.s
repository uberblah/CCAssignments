...
movl %ecx/*3*/, %ebx/*a*/
call input
movl %eax/*('reg', '%eax')*/, %esi/*43*/
call input
movl %eax/*('reg', '%eax')*/, %ecx/*44*/
movl %esi/*43*/, %edi/*41*/
addl %ecx/*44*/, %edi/*41*/
call input
movl %eax/*('reg', '%eax')*/, %esi/*45*/
call input
...
movl %edi/*59*/, %eax/*56*/
addl %ecx/*60*/, %eax/*56*/
movl %esi/*55*/, 4(%esp)/*53*/
addl %eax/*56*/, 4(%esp)/*53*/
call input
movl %eax/*('reg', '%eax')*/, %esi/*63*/
call input
movl %eax/*('reg', '%eax')*/, %ecx/*64*/
movl %esi/*63*/, %edi/*61*/
addl %ecx/*64*/, %edi/*61*/
call input
movl %eax/*('reg', '%eax')*/, %esi/*65*/
call input
