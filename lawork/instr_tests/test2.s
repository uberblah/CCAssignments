...
call print_int_nl
popl %ecx/*('reg', '%ecx')*/
movl 4(%esp)/*x*/, %eax/*137*/
movl %eax/*137*/, %ecx/*136*/
negl %ecx/*136*/
movl %ecx/*136*/, %eax/*134*/
negl %eax/*134*/
movl %ebx/*y*/, %ecx/*142*/
movl %ecx/*142*/, %ebx/*141*/
negl %ebx/*141*/
movl %ebx/*141*/, %ecx/*140*/
negl %ecx/*140*/
movl %ecx/*140*/, %ebx/*139*/
negl %ebx/*139*/
movl %ebx/*139*/, %ecx/*138*/
negl %ecx/*138*/
movl %ecx/*138*/, %ebx/*135*/
negl %ebx/*135*/
movl %eax/*134*/, %ecx/*132*/
addl %ebx/*135*/, %ecx/*132*/
movl %edi/*z*/, %eax/*144*/
movl %eax/*144*/, %ebx/*143*/
negl %ebx/*143*/
movl %ebx/*143*/, %eax/*133*/
negl %eax/*133*/
movl %ecx/*132*/, %ebx/*130*/
addl %eax/*133*/, %ebx/*130*/
movl $7/*('lit', 7)*/, %eax/*145*/
movl %eax/*145*/, %ecx/*131*/
negl %ecx/*131*/
movl %ebx/*130*/, %eax/*128*/
addl %ecx/*131*/, %eax/*128*/
